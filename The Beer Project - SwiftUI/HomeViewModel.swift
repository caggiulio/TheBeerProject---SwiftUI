...
public class HomeViewModel: ObservableObject {
    ...
    @ObservedObject var searchText: SearchString = SearchString() {
        didSet {
            ...
            self.page = 1
            self.getBeers(page: self.page, beerName: searchText.string, category: "")
        }
    }
    ...
    init() {
        getBeers(page: page, beerName: searchText.string, category: "")
    }
